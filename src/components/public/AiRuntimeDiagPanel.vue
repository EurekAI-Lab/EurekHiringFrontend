...
const entries = computed(() => {
  ...
  return [
    ...
    { key: 'nativeSafeTop', label: 'nativeTop', value: stringifyValue(data.nativeSafeTop) },
    { key: 'cssEnvSafeTop', label: 'cssEnvTop', value: stringifyValue(data.cssEnvSafeTop) },
    { key: 'resolvedAiSafeTop', label: 'aiSafeTop', value: stringifyValue(data.resolvedAiSafeTop) },
