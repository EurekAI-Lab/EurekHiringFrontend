  ...
  <view class="w-full bg-#f5f7fb min-h-[210vw] h-auto relative overflow-y-auto">
    ...
    <view>
      <wd-action-sheet v-model="showSheet" title="选择职位" @close="close">
        ...
        <view class="flex w-full h-16 justify-center items-center py-1" v-for="(item, index) in items" :key="index">
        ...
        <view class="mb-10 w-full pt-4 flex justify-center items-center">
          <view @click="close()" class="w-[80%] h-10 rounded-md bg-#1778ff flex justify-center items-center text-white">
            确定
          </view>
        </view>
      </wd-action-sheet>
